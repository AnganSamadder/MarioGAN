 ...
 * 
 * Additionally, if you send in a 2D array where each sub-array has length 32,
 * this will be interpreted as several
 * latent vectors. Each latent vector will create a separate level segment, and
 * the segments will be stitched together
...
public class MarioLevelPlayer {
	...
	public static void main(String[] args) throws IOException {
		...
		// Launch Mario with visualization enabled (third argument)
		marioProcess.launchMario(new String[0], true, true); // true means there is a human player
