...
echo "Starting SAGAN training on GPU ${CUDA_VISIBLE_DEVICES} for ${NUM_EPOCHS} epochs..."
...
nohup bash -c "
  ...
  stdbuf -oL -eL python3 main.py --cuda --niter ${NUM_EPOCHS} --experiment \"${SAMPLES_DIR}\"
" > "${LOG_FILE}" 2>&1 &
